		...
		<div class="box" data-box="router-log">
			...
			<script type="text/javascript">
				...
				$('#router-log').forms([
					...
					{ title: '事件记录', text: '<small>(某些改动将在重启后生效)</small>' },
					...
					{ title: '记录任务计划', indent: 2, name: 'f_log_sched', type: 'checkbox', value: (nvram.log_events.indexOf('sched') != -1) },
					{ title: '记录连接日志' },
		...
		<div class="box" data-box="webmon-settings">
			...
			<script type='text/javascript'>
				$('#webmon').forms([
					...
					{ title: '每日备份', name: 'f_webmon_bkp', type: 'checkbox', value: nvram.webmon_bkp == 1, suffix: ' <small>(每晚12点)</small>' },

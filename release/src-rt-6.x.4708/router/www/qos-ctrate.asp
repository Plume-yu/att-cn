...
<content><style type="text/css">
	...
	<script type="text/javascript">
		if (nvram.qos_enable != '1') {
			$('.container .ajaxwrap').prepend('<div class="alert alert-info"><b>已禁用。</b>&nbsp; <a class="ajaxload" href="#qos-settings.asp">启用 &raquo;</a> <a class="close"><i class="icon-cancel"></i></a></div>');
		}
	</script>
	...
	<div class="box" id="qos-transfer-rates">
		...
		<div class="content">
			<h4>筛选 <a href="javascript:toggleVisibility('filters');"><span id="sesdivfiltersshowhide"><i class="icon-chevron-up"></i></span></a></h4>
			<div class="section" id="sesdivfilters" style="display:none"></div>
			<script type="text/javascript">
				var c;
				c = [];
				c.push({ title: '只显示这些IP', name: 'f_filter_ip', size: 50, maxlen: 255, type: 'text', suffix: ' <small>(逗号分隔列表)</small>' });
				c.push({ title: '排除这些IP', name: 'f_filter_ipe', size: 50, maxlen: 255, type: 'text', suffix: ' <small>(逗号分隔列表)</small>' });
				c.push({ title: '排除网关通信', name: 'f_excludegw', type: 'checkbox', value: ((nvram.t_hidelr) == '1' ? 1 : 0) });
				c.push({ title: '排除IPv4广播', name: 'f_excludebcast', type: 'checkbox' });
				c.push({ title: '排除IPv4组播', name: 'f_excludemcast', type: 'checkbox' });
			...
			<div id="loading"><br><b>加载中...</b> <div class="spinner"></div></div>
		</div>
	</div>

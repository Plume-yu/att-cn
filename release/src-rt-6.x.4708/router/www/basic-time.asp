		...
		<div class="box">
			...
			<div class="content">
				...
				<script type="text/javascript">
					...
					$('#timesec').forms([
						{ title: '路由时间', text: '<span id="clock"><% time(); %></span>' },
						null,
						{ title: '时区', name: 'tm_sel', type: 'select', options: [
							['custom','自定义...'],
							['UTC12','UTC-12:00 夸贾林环礁(位于太平洋西部)'],
							['UTC11','UTC-11:00 中途岛，萨摩亚'],
							['UTC10','UTC-10:00 夏威夷'],
							['NAST9NADT,M3.2.0/2,M11.1.0/2','UTC-09:00 阿拉斯加州'],
							['PST8PDT,M3.2.0/2,M11.1.0/2','UTC-08:00 太平洋时间'],
							['UTC7','UTC-07:00 亚利桑那州'],
							['MST7MDT,M3.2.0/2,M11.1.0/2','UTC-07:00 山地时间'],
							['UTC6','UTC-06:00 墨西哥'],
							['CST6CDT,M3.2.0/2,M11.1.0/2','UTC-06:00 中部时间'],
							['UTC5','UTC-05:00 哥伦比亚,巴拿马到'],
							['EST5EDT,M3.2.0/2,M11.1.0/2','UTC-05:00 东部时间'],
							...
							['NST3:30NDT,M3.2.0/0:01,M11.1.0/0:01','UTC-03:30 纽芬兰'],
							['WGST3WGDT,M3.5.6/22,M10.5.6/23','UTC-03:00 格陵兰'],
							['BRT3BRST,M10.3.0/0,M2.3.0/0','UTC-03:00 巴西东部'],
							['UTC3','UTC-03:00 阿根廷,法属圭亚那,苏里南'],
							['UTC2','UTC-02:00 中部大西洋'],
							['STD1DST,M3.5.0/2,M10.5.0/2','UTC-01:00 亚速尔群岛'],
							['UTC0','UTC+00:00 冈比亚,利比里亚,摩洛哥'],
							...
							['UTC-3','UTC+03:00 伊拉克,约旦,加里宁格勒,科威特'],
							['UTC-4','UTC+04:00 莫斯科,阿曼,阿拉伯联合酋长国'],
							...
							['UTC-8','UTC+08:00 中国, 香港,克拉斯诺亚尔斯克,西澳大利,亚州,新加坡,台湾'],
							...
							['AEST-10', 'UTC+10:00 布里斯班,雅库茨克'],
							['UTC-11','UTC+11:00 所罗门群岛,关岛,符拉迪沃斯托克'],
							['UTC-12','UTC+12:00 斐济,马加丹'],
							['NZST-12NZDT,M9.5.0/2,M4.1.0/3','UTC+12:00 新西兰']
							], value: nvram.tm_sel },
						{ title: '自动夏令时', indent: 2, name: 'f_tm_dst', type: 'checkbox', value: nvram.tm_dst != '0' },
						{ title: '自定义时区名称', indent: 2, name: 'f_tm_tz', type: 'text', maxlen: 32, size: 34, value: nvram.tm_tz || '' },
						null,
						{ title: '自动更新时间', name: 'ntp_updates', type: 'select', options: [[-1,'不更新'],[0,'开机更新'],[1,'每小时'],[2,'每2小时'],[4,'每4小时'],[6,'每6小时'],[8,'每8小时'],[12,'每12小时'],[24,'每24小时']],
							value: nvram.ntp_updates },
						{ title: '按需触发连接', indent: 2, name: 'f_ntp_tdod', type: 'checkbox', value: nvram.ntp_tdod != '0' },
						{ title: 'NTP时间服务器', name: 'f_ntp_server', type: 'select', options: ntpList, value: ntpSel },

...
<content>
	...
	<div class="box">
		<div class="heading">网页认证管理设置</div>
		<div class="content">
				...
				<form id="upload-form" method="post" action="uploadsplash.cgi?_http_id=<% nv(http_id); %>" enctype="multipart/form-data">
					<fieldset><label class="col-sm-3 control-left-label" for="upload-name">自定义文件</label>
						<div class="col-sm-9">
							...
							<button type="button" name="f_upload_button" id="upload-button" value="Upload" onclick="uploadButton()" class="btn btn-danger">上传 <i class="icon-upload"></i></button>
						</div>
					</fieldset>
				</form>
			</div>

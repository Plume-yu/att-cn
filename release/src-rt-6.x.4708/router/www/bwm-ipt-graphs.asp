	...
	<div class="fluid-grid x3">
		...
		<div class="box graphs">
			...
			<div class="content">
				...
				<table id="secondTable">
					<tr><td class="color" style="height:1em"></td><td class="title" style="width:45px">&nbsp;</td><td class="thead count">kbit/s</td><td class="thead count">KB/s</td><td class="pct">&nbsp;</td></tr>
					<tr><td>&nbsp;</td><td class="total">总计</td><td id="bcnt-total" class="total count"></td><td id="bcntx-total" class="total count"></td><td class="total pct">100%</td></tr>
				</table>
			</div>
		</div>
		...
		<div class="box graphs">
			...
			<div class="content">
				...
				<table id="thirdTable">
					<tr><td class="color" style="height:1em"></td><td class="title" style="width:45px">&nbsp;</td><td class="thead count">kbit/s</td><td class="thead count">KB/s</td><td class="pct">&nbsp;</td></tr>
					<tr><td>&nbsp;</td><td class="total">总计</td><td id="obcnt-total" class="total count"></td><td id="obcntx-total" class="total count"></td><td class="total pct">100%</td></tr>
				</table>
			</div>
		</div>
	</div>

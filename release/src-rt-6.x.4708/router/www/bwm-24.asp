...
<content>
	...
	<script type="text/javascript">
		...
		function init()
		{
			if (nvram.rstats_enable != '1') { $('#rstats').before('<div class="alert alert-warning">带宽监控已禁用。</b> <a href="/#admin-bwm.asp">开启 &raquo;</a></div>'); return; }
	...
	<div id="rstats" class="box">
		<div class="heading">
			24小时带宽历史 &nbsp; <div class="spinner" id="refresh-spinner" style="visibility:hidden;" onclick="debugTime=1"></div>
			<a href="#" data-toggle="tooltip" onclick="ref.toggleX(); return false;" title="自动刷新视图" class="pull-right" id="refresh-but"><i class="icon-refresh"></i></a>
		</div>
		<div class="content">
			...
			<div id="bwm-controls">
				...
				<a href="javascript:switchScale(1)" id="scale1">独立</a>
				| <b>显示</b>:
				<a href="javascript:switchDraw(0)" id="draw0">填充</a> 或
				<a href="javascript:switchDraw(1)" id="draw1">线条</a>
			...
			<table id="txt" class="data-table bwm-info">
				...
				<tr>
					<td><b style="border-bottom:blue 1px solid" id="tx-name">上行</b>
			...
			<div id="rbusy" class="alert alert-warning" style="display:none">警告：10秒会话超时，重新启动..&nbsp;</div>

		...
		<div class="fluid-gr" id="mounties">
			<script type="text/javascript">
				...
				createFormFields([
					...
					{ title: 'Netbios名称', indent: 2, name: 'f_cifs1_servern', type: 'text', maxlen: 128, size: 48, value: a[6] },
				...
				createFormFields([
					...
					{ title: 'Netbios名称', indent: 2, name: 'f_cifs2_servern', type: 'text', maxlen: 128, size: 48, value: b[6] },

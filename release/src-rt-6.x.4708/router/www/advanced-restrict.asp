...
<content>
	...
	<script type="text/javascript">
		...
		og.setup = function() {
			...
			var r = this.footerSet(['<button type="button" value="Add" onclick="TGO(this).addEntry()" id="res-over-add" class="btn btn-danger">增加 <i class="icon-plus"></i></button>']);
			r.cells[0].colSpan = 2;
		}

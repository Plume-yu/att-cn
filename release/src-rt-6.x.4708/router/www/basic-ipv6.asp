...
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" id="section-ipv6">
			<div class="heading">IPv6 基本设置</div>
			...
			<div class="content">
				...
				<script type="text/javascript">
					...
					$('#section-ipv6 .formfields').forms([
		                 ...
		                 { title: 'IPv6 WAN接口', name: 'ipv6_ifname', type: 'text', maxlen: 8, size: 10, value: nvram.ipv6_ifname },
		                 null,
		                 { title: 'Assigned / Routed Prefix', name: 'f_ipv6_prefix', type: 'text', maxlen: 46, size: 48, value: nvram.ipv6_prefix },
		                 { title: '6RD路由前缀', name: 'ipv6_6rd_prefix', type: 'text', maxlen: 46, size: 48, value: nvram.ipv6_6rd_prefix },
		                 { title: '6RD前缀长度', name: 'ipv6_6rd_prefix_length', type: 'text', maxlen: 3, size: 5, value: nvram.ipv6_6rd_prefix_length, suffix: ' <small>(通常 32)</small>' },
		                 { title: '前缀长度', name: 'f_ipv6_prefix_length', type: 'text', maxlen: 3, size: 5, value: nvram.ipv6_prefix_length },
		                 { title: '仅请求PD', name: 'f_ipv6_pdonly', type: 'checkbox', value: (nvram.ipv6_pdonly != '0') },
		                 ...
		                 { title: '静态DNS', name: 'f_ipv6_dns_1', type: 'text', maxlen: 46, size: 48, value: dns[0] || '' },
		                 ...
		                 null,
		                 { title: '隧道远程端点 (IPv4 地址)', name: 'ipv6_tun_v4end', type: 'text', maxlen: 15, size: 17, value: nvram.ipv6_tun_v4end },
		                 { title: '6RD Tunnel Border Relay (IPv4 地址)', name: 'ipv6_6rd_borderrelay', type: 'text', maxlen: 15, size: 17, value: nvram.ipv6_6rd_borderrelay },
		                 { title: '6RD IPv4掩码长度', name: 'ipv6_6rd_ipv4masklen', type: 'text', maxlen: 3, size: 5, value: nvram.ipv6_6rd_ipv4masklen, suffix: ' <small>(通常 0)</small>' },
		                 { title: '中继广播地址', name: 'ipv6_relay', type: 'text', maxlen: 3, size: 5, prefix: '192.88.99.&nbsp&nbsp', value: nvram.ipv6_relay },
		                 ...
		                 { title: '隧道MTU', name: 'ipv6_tun_mtu', type: 'text', maxlen: 4, size: 8, value: nvram.ipv6_tun_mtu, suffix: ' <small>(默认：0)</small>' },
		                 { title: '隧道TTL', name: 'ipv6_tun_ttl', type: 'text', maxlen: 3, size: 8, value: nvram.ipv6_tun_ttl },
		                 null,

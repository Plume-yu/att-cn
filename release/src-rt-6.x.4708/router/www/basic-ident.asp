			...
			<div class="content">
				...
				<script type="text/javascript">
					$('#identification').forms([
						...
						{ title: '主机名', name: 'wan_hostname', type: 'text', maxlen: 63, size: 34, value: nvram.wan_hostname },
						{ title: '域名', name: 'wan_domain', type: 'text', maxlen: 32, size: 34, value: nvram.wan_domain }
					]);
				</script>
			</div>
		</div>

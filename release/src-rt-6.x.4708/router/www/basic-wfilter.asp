...
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box">
			...
			<div class="content">
				<div class="radio c-radio"><label><input type="radio" name="f_type" id="_f_disable" value="disabled"><span class="icon-check"></span> 禁用过滤</label></div>
				&nbsp;
				<div class="radio c-radio"><label><input type="radio" name="f_type" id="_f_allow" value="allow"><span class="icon-check"></span> 仅允许以下客户端</label></div>
				&nbsp;
				<div class="radio c-radio"><label><input type="radio" name="f_type" id="_f_deny" value="deny"><span class="icon-check"></span> 阻止以下客户端</label></div>

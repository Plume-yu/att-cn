...
<content><style type="text/css">
	...
	<script type="text/javascript">
		...
		function clearLog(clear)
		{
			...
			E('clear' + clear).innerHTML = '请稍候... <div class="spinner"></div>';
		}
	...
	<div class="row" id="webmon" style="display:none">
		...
		<div id="webmon-controls">
			...
			&raquo; <a class="ajaxload" href="admin-log.asp">网页监控设置</a>
			<br><br>
		</div>
	</div>
	...
	<div id="wm-disabled" class="alert alert-info icon">
		<h5>网页监控已禁用</h5>
		请 <a class="ajaxload" href="/#admin-log.asp">启用</a> 网页监控，以统计浏览信息。
	</div>

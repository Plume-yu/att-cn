...
<content>
	...
	<div id="cstats" class="box">
		<div class="heading">
			24小时 IP流量历史 &nbsp; <div class="spinner" id="refresh-spinner" style="visibility:hidden;" onclick="debugTime=1"></div>
		...
		<div class="content">
			...
			<span id="dtime"></span>
			<div class="alert alert-warning" style="display:none" id="rbusy">程序忙或没有响应. 请几秒钟后重新加载。</div>
		</div>
	</div>

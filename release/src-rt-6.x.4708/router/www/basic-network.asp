			...
			<script type="text/javascript">
				...
				for ( var uidx = 1; uidx <= maxwan_num; ++uidx ) {
					...
					$( '#wan-settings' ).forms([
						...
						{ title: 'APN', name: 'wan' + u + '_modem_apn', type: 'text', maxlen: 25, size: 32, suffix: ' <i>如果为空, 将不会发送AT+CGDCONT</i>', value: nvram[ 'wan' + u + '_modem_apn' ] },
						{ title    : '网络类型',
						...
						{ title: '漫游', name: 'wan'+u+'_modem_roam', type: 'select', options: [['2', '不改变*'],['1', '启用支持'],['0', '禁用'],['3', '仅漫游']], value: nvram['wan'+u+'_modem_roam'], suffix: ' <small>*默认; 不兼容Hilink调制解调器<\/small>' },
						{ title: 'LTE 频段', name: 'wan'+u+'_modem_band', type: 'select', options: [['7FFFFFFFFFFFFFFF', '全部频段率*'],['80000', 'B20 (800 MHz)'],['4', 'B3 (1800 MHz)'],['1', 'B1 (2100 MHz)'],['40', 'B7 (2600 MHz)']], value: nvram['wan'+u+'_modem_band'], suffix: ' <small>*默认; 仅在非Hilink调制解调器测试<\/small>' },

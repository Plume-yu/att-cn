...
<content>
	...
	<div id="rstats" class="box">
		<div class="heading">每日带宽监控 <a class="pull-right" href="#" data-toggle="tooltip" title="重新加载信息" onclick="reloadPage(); return false;"><i class="icon-refresh"></i></a></div>
		<div class="content">
			...
			<div class="span2" style="float: left; margin-left: 20px;">
				<table class="data-table">
					...
					<tbody>
						<tr><td>下行</td><td id="last-dn">-</td></tr>
						<tr><td>上行</td><td id="last-up">-</td></tr>
						<tr><td>总计</td><td id="last-total">-</td></tr>
					</tbody>
				</table>
				<hr/>

				<b>日期</b>: &nbsp; <select onchange="changeDate(this, 'ymd')" id="dafm"><option value=0>yyyy-mm-dd</option><option value=1>mm-dd-yyyy</option><option value=2>mmm dd, yyyy</option><option value=3>dd.mm.yyyy</option></select><br>
				<b>单位</b>: &nbsp; <select onchange="changeScale(this)" id="scale"><option value=0>KB</option><option value=1>MB</option><option value=2 selected>GB</option></select><br>

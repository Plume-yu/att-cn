	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="qos-lan-limit">
			...
			<div class="content">
				...
				<ul>
					<li><b>IP地址/ IP范围:</b>
					<li>例如: 192.168.1.5 ，单IP
					<li>例如: 192.168.1.4-7 为 192.168.1.4 到 192.168.1.7，IP范围
					<li>例如: 4-7 表示IP范围 .4 到 .7
					<li><b>IP范围内的设备将共享带宽</b>
					<li><b>MAC地址</b> 如: 00:2E:3C:6A:22:D8
				</ul>
			</div>
		</div>
		...
		<div class="box" id="qoslimitbr0" data-box="qos-br0-limit">
			...
			<div class="content">
				...
				<ul>
					<li>默认分类 - 未分类的IP/MAC 地址将被归为默认分类</li>
					<li>所有未分类的主机将共享带宽（br0）</li>
				</ul>
			</div>
		</div>
